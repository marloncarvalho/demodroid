...
import br.gov.frameworkdemoiselle.persistence.annotation.GeneratedValue;
...
public class MappedEntity {
	...
	public boolean isIDColumnAutoGenerated() {
		MappedColumn mappedColumn = getIdMappedColumn();
		return mappedColumn.getField().isAnnotationPresent(GeneratedValue.class);
	}
